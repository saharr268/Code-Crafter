  ...
  return (
    <footer className="bg-background-dark text-white py-10">
      <div className="max-w-6xl mx-auto text-center px-4">
        ...
        <div className="flex justify-center gap-10 mt-10 text-white">
          <a className="hover:text-teal-500" href="/support">پشتیبانی</a>
          <a className="hover:text-teal-500" href="/resources">منابع</a>
          <a className="hover:text-teal-500" href="/practice">تمرین</a>
          <a className="hover:text-teal-500" href="/learn">آموزش</a>
    ...
    <div className="flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="flex items-center gap-2 mt-10 text-white">
          <span><TbMailFilled /></span>
          <a href="mailto:info@codetoinspire.org">info@codetoinspire.org</a>
        </div>

         {/* Social Icons */}
          <div className="flex space-x-4 text-m mt-12">
            <a href="https://www.facebook.com/CodeToInspire/" className="hover:text-teal-500">
              <FaFacebookF />
            </a>
            <a href="https://www.instagram.com/codetoinspire/?hl=en" className="hover:text-teal-500">
              <FaInstagram />
            </a>
            <a href="https://www.linkedin.com/company/code-to-inspire/posts/?feedView=all" className="hover:text-teal-500">
              <FaLinkedinIn />
            </a>
          </div>
