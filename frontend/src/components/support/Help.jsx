            ...
            <AnimationSlideIn direction="right">
              ...
              >
                <div className="max-w-5xl mx-auto leading-8">
                  ...
                  <p className="mb-6">
                    تقریبا تمامی مرورگرها در پلتفرم‌های مختلف گزینه‌ای برای
                    دانلود کامل صفحات وب دارند...
                  </p>
                  ...
                  <p>
                    نکته: می‌توانید به‌جای مراحل گفته شده، برای دسترسی به
                    پنجره‌ی ذخیره‌سازی صفحه‌وب، در ویندوز از Ctrl + S و در مک از
                    Command + S استفاده کنید. در پنجره‌ی باز شده، مطمئن شوید که
                    Save as type روی Webpage,Complete تنظیم شده است.
                  </p>
                </div>
              </section>
            </AnimationSlideIn>
              ...
              >
                <div dir="rtl" className="w-full">
                  ...
                  <p className="text-gray-600 text-sm leading-6 mb-6">
                    ...
                    لطفا تجربه‌ی خود را درباره‌ی وبسایت صدا با به اشتراک
                    بگذارید.
                  </p>
