    ...
    <section className="bg-white py-12 px-6">
      ...
      >
        ...
        <p className="mt-6 text-justify">
          نکته: با فشردن <span className="font-semibold">Ctrl + S</span> در
          ویندوز یا <span className="font-semibold">Command + S</span> در مک
          می‌توانید صفحه را ذخیره کنید.
        </p>
      </div>
    </section>
  );
