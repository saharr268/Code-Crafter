...
const MostVisitedPost = () => {
  return (
    <div className="flex flex-col items-center justify-center px-4 py-12">
      {/* Page Title */}
      <h2 className="text-right text-gray-800 font-medium text-lg md:text-xl mb-6 w-full max-w-7xl">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between bg-gray-100 rounded-3xl shadow-sm p-8 md:p-10 w-full max-w-6xl mx-auto">
        ...
        <div className="w-full md:w-1/2 text-right md:pr-10">
          ...
          <p className="text-gray-700 text-sm md:text-base leading-7 mb-16 line-clamp-3">
            اهمیت امنیت در دنیای دیجیتال در حفاظت از اطلاعات ارزشمند، حفظ حریم خصوصی افراد و سازمان‌ها،
            جلوگیری از سرقت هویت و خسارات مالی، حفظ اعتبار و اطمینان از عملکرد صحیح سیستم‌ها و شبکه‌ها نهفته است.
          </p>
