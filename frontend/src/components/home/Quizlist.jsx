...
const quizItems = [
  ...
  { feedback: ['هک سیستم و سرقت اطلاعات', 'فیشینگ و سواستفاده‌ی مالی'], types: ['red', 'green'] },
  { feedback: ['فیشینگ و سواستفاده‌ی مالی'], types: ['green'] },
  { feedback: ['فیشینگ و سواستفاده‌ی مالی'], types: ['green'] },
  { feedback: ['فیشینگ و سواستفاده‌ی مالی'], types: ['green'] },
  { feedback: ['فیشینگ و سواستفاده‌ی مالی'], types: ['green'] },
      ...
      <div className="max-w-full mx-auto px-[160px] py-4">
       ...
       <h1 className="text-xl font-bold mb-6 mr-[-70px]">تمرینات و کوئیزها</h1>
        ...
        {quizItems.map((item, index) => (
          <div
  key={index}
  className={`py-6 ${index === quizItems.length - 1 ? '' : 'border-b'}`}
>
            ...
            <div className="flex flex-row-reverse items-start gap-[26px]">
              ...
              <p className="text-sm md:text-base leading-relaxed flex-1 text-right">
                شما ایمیلی دریافت می‌کنید که می‌گوید: «حساب شما قفل خواهد شد! برای تأیید ورود اینجا کلیک کنید.»
                پس از کلیک، رمز عبور خود را در یک سایت جعلی وارد می‌کنید. این چه نوع حمله‌ای است؟
              </p>
            </div>
