      ...
      <section className="flex flex-col md:flex-row-reverse items-center justify-between px-12 md:px-20 py-12 bg-white">
        ...
        >
          ...
          <p className="text-text-body leading-6 mb-6">
            ...
            در زمینه‌ی امنیت دیجیتال فعالیت می‌کند. در دنیای امروز که بخش بزرگی
            از ارتباطات، یادگیری و حتی فعالیت‌های اجتماعی در فضای مجازی شکل
            می‌گیرد، آگاهی از خطرات آنلاین و یادگیری مهارت‌های ایمنی در این فضا
            بسیار ضروری است. صدا به زنان کمک می‌کند تا بدانند چگونه در حریم
            خصوصی خود محافظت کنند، حساب‌های کاربری‌شان را ایمن‌تر سازند و در
            برابر تهدیدهایی مانند هک، آزار آنلاین یا انتشار اطلاعات شخصی
            مقاوم‌تر باشند.
          </p>
          <button
