        ...
        >
                ...
                {isPending
                  ...
                  : lessonData?.map(({ id, thumbnail_url, title }) => (
                      <div
                        ...
                        key={id}
                        className="flex items-center justify-between gap-x-3 rounded-2xl cursor-pointer hover:border hover:border-solid hover:border-gray-500 border-solid border border-background-card"
                      >
                        <img
          ...
          >
            ...
            >
              ...
              {isPending ? (
                <CustomShimmer className="w-full h-96" />
              ) : (
                <div
